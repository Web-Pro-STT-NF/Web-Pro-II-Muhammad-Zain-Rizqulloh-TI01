...
class Sewa extends CI_Controller
{
    ...
    public function berhasil()
    {
        ...
        $this->load->model("sewa_model", "sewa");
        $sewaberhasil = $this->sewa->findById($_id);

        $this->load->model("users_model", "users");
        $usersberhasil = $this->users->findById($_id);

        $this->load->model("mobil_model", "mobil");
        $mobilberhasil = $this->mobil->findById($_id);

        
        $data['judul'] = 'Form Update mobil';
        $data['sewaberhasil'] = $sewaberhasil; 
        $data['usersberhasil'] = $usersberhasil;
        $data['mobilberhasil'] = $mobilberhasil;  


        $this->load->view('sewa/berhasil', $data);
